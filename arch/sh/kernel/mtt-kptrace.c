...
static int context_switch_pre_handler(struct kprobe *p, struct pt_regs *regs)
{
	 ...
	 * __switch_to function has 2 arguments:
	 * Previous pid: ((struct task_struct *)regs->REG_ARG0)->pid
	 * New pid:  ((struct task_struct *)regs->REG_ARG1)->pid
	 */
	new =  ((struct task_struct *)regs->REG_ARG1)->pid;
