/*
 * arch/sh/boards/mach-b2108/setup.c
 *
...
#define B2108_GPIO_POWER_ON_ETH		stm_gpio(3, 3)
#define B2108_MII1_TXER			stm_gpio(0, 4)
#define B2108_POWER_ON                  stm_gpio(3, 7)
...
static struct platform_device b2108_leds = {
	.name = "leds-gpio",
	.id = -1,
	.dev.platform_data = &(struct gpio_led_platform_data) {
		...
		.leds = (struct gpio_led[]) {
			 ...
			 *
			 * This has been fixed on B2108 revB, so if you know
...
static struct tm1668_key b2108_front_panel_keys[] = {
...
static struct tm1668_character b2108_front_panel_characters[] = {
	TM1668_7_SEG_HEX_DIGITS,
	TM1668_7_SEG_SEGMENTS,
	TM1668_7_SEG_LETTERS
};

static struct platform_device b2108_front_panel = {
	.name = "tm1668",
	.id = -1,
	.dev.platform_data = &(struct tm1668_platform_data) {
		...
		.keys_num = ARRAY_SIZE(b2108_front_panel_keys),
		.keys = b2108_front_panel_keys,
		.keys_poll_period = DIV_ROUND_UP(HZ, 5),

		.brightness = 8,
		.characters_num = ARRAY_SIZE(b2108_front_panel_characters),
		.characters = b2108_front_panel_characters,
		.text = "H238",
	},
};

/* Serial Flash */
static struct stm_plat_spifsm_data b2108_serial_flash =  {
	.name		= "n25q256",
	.nr_parts	= 2,
...
/* NAND Flash */
static struct stm_nand_bank_data b2108_nand_flash = {
...
static int b2108_phy_reset(void *bus)
{
	/*
	 ...
	 */
	gpio_set_value(B2108_GPIO_POWER_ON_ETH, 0);
	mdelay(10);
	gpio_set_value(B2108_GPIO_POWER_ON_ETH, 1);
	mdelay(10);
...
static struct stmmac_mdio_bus_data stmmac_mdio_bus = {
	.phy_reset = b2108_phy_reset,
	.phy_mask = 0,
	.probed_phy_irq = ILC_IRQ(25), /* MDINT */
};

static struct platform_device *b2108_devices[] __initdata = {
	&b2108_leds,
	&b2108_front_panel,
};
...
static int __init device_init(void)
{
	 ...
	 * but it isn't... ;-) */
#if 0	 
	gpio_request(B2108_GPIO_POWER_ON_ETH, "POWER_ON_ETH");
	gpio_direction_output(B2108_GPIO_POWER_ON_ETH, 0);

       gpio_request(B2108_POWER_ON, "POWER_ON");
       gpio_direction_output(B2108_POWER_ON, 0);
	...
	stxh205_configure_nand(&(struct stm_nand_config) {
			.driver = stm_nand_bch,
			.nr_banks = 1,
			.banks = &b2108_nand_flash,
			.bch_ecc_cfg = BCH_ECC_CFG_18BIT,});

	stxh205_configure_spifsm(&b2108_serial_flash);

	return platform_add_devices(b2108_devices,
			ARRAY_SIZE(b2108_devices));
}
arch_initcall(device_init);

struct sh_machine_vector mv_b2108 __initmv = {
	.mv_name = "b2108",
	.mv_setup = b2108_setup,
	.mv_nr_irqs = NR_IRQS,
};
...
static int b2108_board_freeze(struct stm_wakeup_devices *wkd)
{
...
static int b2108_board_defrost(void)
{
	b2108_phy_reset(NULL);
	return 0;
}

static struct stm_hom_board b2108_hom = {
	.freeze = b2108_board_freeze,
	.restore = b2108_board_defrost,
};

static int __init b2108_hom_register(void)
{
	return stm_hom_board_register(&b2108_hom);
}

module_init(b2108_hom_register);
#endif
