...
/* STM3 configuration (H407 / STID127) */
#if defined(CONFIG_MACH_STM_STIH407) || defined(CONFIG_MACH_STM_STID127)

  #define STM_IP_CH_SHIFT      STM_IPv3_CH_SHIFT
  #define STM_IP_CH_OFFSET     STM_IPv3_CH_OFFSET
  #define STM_IP_MA_SHIFT      STM_IPv3_MA_SHIFT
  #define STM_IP_TS_OFFSET     STM_IPv3_TS_OFFSET
  #define STM_IP_CH_NUMBER     STM_IPv3_CH_NUMBER
  #define STM_IP_VERSION       STM_IPv3
  #define STM_PERI_ID          0x00680dec
  #define STM_CELL_ID          0xb105f00d

/* Default configuration: STM1 (H415 / H416) */
#else

  #define STM_IP_CH_SHIFT      STM_IPv1_CH_SHIFT
  #define STM_IP_CH_OFFSET     STM_IPv1_CH_OFFSET
  #define STM_IP_MA_SHIFT      STM_IPv1_MA_SHIFT
  #define STM_IP_TS_OFFSET     STM_IPv1_TS_OFFSET
  #define STM_IP_CH_NUMBER     STM_IPv1_CH_NUMBER
  #define STM_IP_VERSION       STM_IPv1
  #define STM_PERI_ID          0x00380dec
  #define STM_CELL_ID          0xb105f00d
...
#define MTT_CH_LIN_APP_INVALID	(MTT_CH_INVALID + \
				(STM_IP_CH_NUMBER-MTT_CH_INVALID)/2)
#define MTT_CH_LIN_KER_FIRST	(MTT_CH_LIN_APP_INVALID)
#define MTT_CH_LIN_KER_INVALID	(STM_IP_CH_NUMBER)
